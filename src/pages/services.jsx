...
export default function services() {
  return (
    <div>
      <Grid columns="three" color="red"
         textAlign="center">
        <Grid.Row  >
          <Grid.Column color="red" >
            <h2> <Icon name="home" size="large" />
             GÜVENLİ ALIŞVERİŞ İLKELERİMİZ </h2>
          </Grid.Column>
          <Grid.Column color="red" textAlign="right">
            <Button  type="submit" size="massive"
              color="black"
            >Detaylı İncele 
      ...
      <Grid centered columns={3}>
        <Grid.Column>
          <Segment>
            ...
            <Rail position="right">
              <Segment color="purple"> <h3>
                 ARTI HİZMETLERLE KEYFİNE BAK !
                </h3></Segment>
            </Rail>
          </Segment>
        </Grid.Column>
     ...
     <Button.Group inverted size="huge" widths="5">
        ...
        <Button inverted color="red" >
        <Icon name="commenting" size="small" /> 
